...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=150,
        help='Sequence length for each time-series window.')
    parser.add_argument(
        '--stride',
        type=int,
        default=1,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Date split (YYYY-MM-DD) for train/test. Overrides train_ratio if set.')
    parser.add_argument(
        '--train_ratio',
        type=float,
        default=0.8,
        help='Train split ratio when split_date is not set.')
    parser.add_argument(
        '--log_returns',
        type=str2bool,
        default=True,
    ...
    parser.add_argument(
        ...
        help='Normalization mode for each window.')
    parser.add_argument(
        '--label_mode',
        type=str,
        default='dummy',
        choices=['dummy', 'regime'],
    ...
    parser.add_argument(
        ...
        help='Optional VIX regime filter.')
